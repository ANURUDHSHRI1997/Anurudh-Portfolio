...
export default function Hire() {
  ...
  const openGmail = () => {
    const email = 'Anurudhshrivastava2@gmail.com';
            ...
            >
              ...
              >
                ...
                <ul className={`space-y-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                  ...
                  <li className="flex items-start">
                    ...
                    <span>4+ years of UI/UX Design & Front-End Development experience</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">✓</span>
                    <span>Worked on 9+ real-world projects across banking, finance & e-commerce</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">✓</span>
                    <span>Strong command over Figma, HTML, CSS, JavaScript & Bootstrap</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">✓</span>
                    <span>Proven ability to collaborate in teams of 4–6 members effectively</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">✓</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">✓</span>
                    <span>Passionate about creating clean, intuitive & engaging user experiences</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <ul className={`space-y-3 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                  ...
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">🎨</span>
                    <span>UI/UX Design using Figma & Adobe XD</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">🌐</span>
                    <span>Responsive Web Development (HTML, CSS, JavaScript)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">📱</span>
                    <span>Mobile Application UI Design</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">⚡</span>
                    <span>Angular & React JS Front-End Development</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">🖼️</span>
                    <span>Graphic Design using Photoshop & After Effects</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">🔧</span>
                    <span>Wireframing, Prototyping & Website Requirement Documentation</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">✨</span>
                    <span>Interactive UI with Framer & Motion Animations</span>
                  </li>
                </ul>
              </motion.div>
